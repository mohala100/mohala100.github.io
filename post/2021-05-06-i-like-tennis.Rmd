...
Okay Dr.Woodward wants me to show yall how magic can be done. I present to you the greatest magic trick in SDS 348....  Reticulate!
```{R}
#R code chunk
library(reticulate)
...
Printing using R and Pythong variables using R
```{python}
#Python code chunk
hi="Hi EVERYONE!"
...
Printing using R and Python variables using R
```{R}
#R code chunk
